...
function DashboardTeacher() {
  ...
  return (
    <>
      <div className="m-5 ml-20 text-[#caae71] flex flex-col gap-7 w-full">
        ...
        <div className="flex gap-32">
          <div className="flex flex-col gap-5">
            ...
            <p>
              Address: <span className="text-[#2d0808]">{Tdec?.Address}</span>
            </p>
            <p>
              Experience:{" "}
              <span className="text-[#2d0808]">{Tdec?.Experience} years</span>
            </p>
          </div>
          <div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center">
            <div className="bg-[#5be0de] text-black w-[70vw] px-14 py-10 rounded-sm">
              ...
              <p className=" border-b-2 py-2">
                We highly appreciate your involvement. Please help us improve by
                filling out this teacher feedback form. Thank you!
              </p>
              ...
              <div className="py-3 flex flex-col justify-center items-center">
                <p className="pb-3 text-center">
                  Do you have suggestions on what we can do to provide you with
                  a better service?
                </p>
                <textarea
