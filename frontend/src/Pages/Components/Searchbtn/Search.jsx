          ...
          course.map((Data) => (
            ...
            >
              ...
              {idArray.includes(Data._id) ? (
                <div
                  onClick={() =>
                    alert("You Already enrolled, pls find other course")
                  }
              ...
              <div className="absolute bottom-2">
                ...
                {Data.schedule
                  .map((daytime) => {
                    return `${daysName[daytime.day]} ${Math.floor(
                      daytime.starttime / 60
                    )}:${
                      daytime.starttime % 60 === 0
                        ? "00"
                        : daytime.starttime % 60
          ...
          <div className="bg-[#008280] w-96 h-[21rem] rounded-md">
            ...
            <div className="flex flex-col justify-center p-5 text-1xl gap-4">
              ...
              <p>
                ...
                <span className="text-white">
                  Postgraduate from{" "}
                  <b className="text-gray-200">{Tdec.PGcollege}</b> with{" "}
                  {Tdec.PGmarks} CGPA
                </span>
              </p>
              <p>
                Experience :{" "}
                <span className="text-white">{Tdec.Experience} years</span>
              </p>
              <p>
                Course :{" "}
                <span className="text-white">{tname.sub.toUpperCase()}</span>
              </p>
