    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center">
      <div className="flex flex-col items-center gap-5 p-5 justify-center h-80 w-92 rounded-md bg-green-500 text-white">
        ...
        <p className="text-center text-gray-900">
          Payment successfully completed! Now you can join the classes. <br />
          Wishing a happy journey with ShieldGuard
        </p>
        <div
          onClick={onClose}
          className=" bg-blue-900 p-2 rounded-md cursor-pointer"
        >
          Back to Dashboard
        </div>
      </div>
